...
module.exports = class AppBootHook {
  ...
  async didLoad() {
    ...
    // 初始化casbin
    const { authz } = this.app.config;
    this.app.rbacEnforcer = await authz.newEnforcer();
  }
  ...
  async didReady() {
    // 应用已经启动完毕
    // 添加定时任务
    // const fggCountSchedule = {
    //   queue: 'queue',
    //   data: {

    //   },
    //   name: 'fggCountSchedule',
    //   opts: {
    //     repeat: {
    //       cron: '*/6000 * * * * *',
    //     },
    ...
    // }
    // const jobs = [fggCountSchedule];
    // // 加入队列
    // await this.app.addJobToQueue(jobs);
  }
